...
class NoImageIconBlock extends \WPBakeryShortCode {

    public function __construct(  ) {

        add_action( 'init', array( $this, 'no_image_icon_block' ) );
        add_shortcode( 'no_image_icon_block', array( $this, 'no_image_icon_block_html' ) );

    }

    public function no_image_icon_block() {

        $vc_globals = vc_globals();

        vc_map( array(
            "base" => "no_image_icon_block",
            "name" => __( "Icon Block - No Image", "js_composer" ),
            "class" => "",
            'icon' => 'icon-wpb-atm',
    ...
    public function no_image_icon_block_html( $atts, $content = NULL ) {
        ...
        ?>
        <div class="icon-block<?php echo $mh;?>"<?php echo $datamh;?>>
